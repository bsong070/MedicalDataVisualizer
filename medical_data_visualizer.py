...
def draw_cat_plot():
    ...
    df_cat['cardio_split'] = np.where(df_cat['variable'] == 'cardio', 1, 0)
...
def draw_heat_map():
    ...
    sns.heatmap(corr, mask=mask, vmax=0.3, center=0, square=True, linewidths=0.5,cbar_kws={'shrink': 0.8}, annot = True, fmt='.1f')
